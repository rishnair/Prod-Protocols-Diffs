...
let payloadFile = fs.readFileSync('/home/runner/work/_actions/rishnair/prod-protocols-diffs/main/src/analytics-autogenerated/plan.json');
let payloadJSON = JSON.parse(payloadFile);
delete payloadJSON["name"];
delete payloadJSON["display_name"];
...
var options = {
    'method': 'PUT',
    'url': 'https://platform.segmentapis.com/v1beta/workspaces/protocols-diffs/tracking-plans/rs_22wccTr4VGjkhIgwv9KTQn3GNIv',
    'headers': {
